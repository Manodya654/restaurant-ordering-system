...
import ItemModal from "./ItemModal"; // Ensure the path is correct
...
export default function MenuGrid({ items }) {
    ...
    const addToCart = (item, quantity = 1) => {
        // You can replace this alert with your actual cart logic
        ...
        <div className="container mx-auto">
                    ...
                    >
                        ...
                        <div className="p-4 flex flex-col justify-between">
                            ...
                            <div className="flex justify-between items-center mt-2">
                                ...
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation(); // Prevents modal from opening when clicking the plus button
                                        addToCart(item);
                                    }}
                                    className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center shadow-md hover:bg-orange-600 transition duration-150"
                                >
            ...
            {selectedItem && (
                <ItemModal
                    item={{
                        ...selectedItem,
                        // Ensure price is a string for the modal's replace logic, 
                        // and map 'image' from DB to 'img' expected by Modal
